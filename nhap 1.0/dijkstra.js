...
graph.addEdge("a2","nhaxegv",3);

//phongyte
graph.addVertex("phongyte");

graph.addEdge("10d","phongyte",11);
graph.addEdge("10e","phongyte",7);
...
graph.addEdge("gate3","b10",2);
graph.addEdge("10d","b10",19);
graph.addEdge("7e","b10",14);

//b11
graph.addVertex("b11");

graph.addEdge("8c","b11",3);
graph.addEdge("8d","b11",5);

//b12
graph.addVertex("b12");

graph.addEdge("8a","b12",3);
graph.addEdge("8b","b12",3);
graph.addEdge("9d","b12",3);
graph.addEdge("9e","b12",3);
